<?php
    ...
    //Boc: 5 -> 1 dan, 2 tableta neiskor.
    //Boc: 6 -> 2 dan, 0 tableta neiskor.
    //Boc: 7 -> 2 dan, 1 tableta neiskor.
    //Boc: 8 -> 2 dan, 2 tableta neiskor.
    //Boc: 9 -> 3 dan, 0 tableta neiskor.
    $n = 40;
    $brojDana = floor($n / 3);
    ...
    echo "<br>";
    echo "Broj neiskoriscenjih tableta: " . $brojNeiskorTableta;
    echo "<hr>";
?>