    ...
    public function up(): void
    {
        Schema::create('film_director', function (Blueprint $table) {
           /* $table->id();
            ...
            $table->foreign('film_id', 'film_people_film_fk')->references('id')->on('films')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign('person_id', 'film_people_person_fk')->references('id')->on('people')->onUpdate('cascade')->onDelete('no action');
        });
    }
